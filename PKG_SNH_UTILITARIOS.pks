...
TYPE var_refcursor IS REF CURSOR;
  ...
  kSoloTexto VARCHAR2 (26 char) := '[^A-Za-z��������������'' ]';
  ...
  K_DET_PX_CRCT        VARCHAR2(20) := 'PX_CRCTR';--Caracter�sitcas
  ...
  K_DIRECTORY_NAME VARCHAR2(20):='DIR_MINSA_IMG';
...
FUNCTION FN_OBT_DATOS_PAGINACION (pDatosPaginacion IN HOSPITALARIO.PKG_CATALOGOS_UTIL.assoc_array_str_datos ) RETURN var_refcursor;                               
 ...
 FUNCTION FN_OBT_COMUNIDAD_ID (pUsalDestinoId IN NUMBER) RETURN NUMBER;
 FUNCTION FN_OBT_DIV_POL_ID (pUsalDestinoId IN NUMBER) RETURN NUMBER;
 FUNCTION FN_OBT_SECTOR (vComunidadId IN  CATALOGOS.SBC_CAT_COMUNIDADES.COMUNIDAD_ID%TYPE) RETURN NUMBER;
 FUNCTION FN_OBT_RED_SERV_ID (pUsalDestinoId IN NUMBER) RETURN NUMBER;
 FUNCTION FN_OBT_SERVICIOID (pCodigo IN HOSPITALARIO.SNH_CAT_SERVICIOS.CODIGO%TYPE) RETURN NUMBER;
 /********* LECTURA Y GUARDADO DE IMAGENES *********/
 /* PROCEDIMIENTO PARA LEER UN ARCHIVO TIPO BLOB DEL DIRECTORIO ESPECIFICADO  */
...
FUNCTION FN_OBT_EDAD_PERSONA_HST (pFechaNac          IN CATALOGOS.SBC_MST_PERSONAS.FECHA_NACIMIENTO%TYPE,
                                  ...
                                  pVariableARetornar IN VARCHAR2) RETURN VARCHAR2;

FUNCTION FN_OBT_CAT_CNF_ID_EVENTOS_HOSP (pCodigo IN VARCHAR2) RETURN NUMBER;

FUNCTION FN_OBT_GRP_ETAREO (pFecNacimiento IN CATALOGOS.SBC_MST_PERSONAS.FECHA_NACIMIENTO%TYPE,
                            pCodigo        IN VARCHAR2) RETURN VARCHAR2;

FUNCTION FN_OBT_GRP_ETAREO_DESCRIPCION (pGrupoEtareoId IN NUMBER) RETURN VARCHAR2; 
